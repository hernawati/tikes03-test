 ...
 * @property string $nama_spesialist
 *
...
class Spesialis extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_spesialis, nama_spesialist', 'required'),
			array('id_spesialis', 'length', 'max'=>5),
			array('nama_spesialist', 'length', 'max'=>45),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_spesialis, nama_spesialist', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nama_spesialist',$this->nama_spesialist,true);
