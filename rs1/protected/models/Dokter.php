 ...
 * @property Spesialis $idSpesialis
 */
class Dokter extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('kode_dokter, nama_dokter, id_spesialis', 'required'),
			array('kode_dokter, id_spesialis', 'length', 'max'=>5),
			array('nama_dokter', 'length', 'max'=>45),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('kode_dokter, nama_dokter, id_spesialis', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'idSpesialis' => array(self::BELONGS_TO, 'Spesialis', 'id_spesialis'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('kode_dokter',$this->kode_dokter,true);
