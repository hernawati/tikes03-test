...
class Dokter extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_dokter, id_spesialis', 'length', 'max'=>5),
			array('nm_dokter', 'length', 'max'=>45),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_dokter, nm_dokter, id_spesialis', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'pendaftarans' => array(self::HAS_MANY, 'Pendaftaran', 'id_dokter'),
		);
	}
